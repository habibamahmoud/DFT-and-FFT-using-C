...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #self.N = np.array([16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384])
        ...
        self.error.clicked.connect(self.showError)
# g++ -fPIC -shared -o libfft.so fft.cpp && python run.py
    ...
    def showError(self):
        ...
        errorArray = error[0: 11]

        print("error :", errorArray)
        self.widget_2.plot(self.N, errorArray, name = "Error", pen = "r")
